...
type DatabaseCredentials struct {
	...
	// Required keys: "root-password" (plaintext password for cn=admin,<suffix>).
	// Optional keys: "replication-password" (plaintext bind password for
	// cn=replication,<suffix>; auto-generated if missing and replication is enabled).
	// When empty, the operator auto-generates a Secret named
	// "<slapddatabase-name>-credentials".
	//
