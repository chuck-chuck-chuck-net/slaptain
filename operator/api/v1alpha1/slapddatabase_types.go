...
type DatabaseCredentials struct {
	...
	// Required keys: "root-password" (plaintext rootDN password).
	// Optional keys: "replication-password" (plaintext syncrepl bind password;
	// auto-generated if missing and replication is enabled).
